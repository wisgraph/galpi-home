                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            {Array.isArray(rustFeatures) && rustFeatures.map((item: any, i: number) => {
                                ...
                                return (
                                    <div key={i} className="p-8 bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-[2rem] hover:shadow-xl transition-all">
                        ...
                        <div className="order-1 lg:order-2 space-y-10">
                            ...
                            <div className="flex flex-col gap-4">
                                {Array.isArray(dataList) && dataList.map((li: string, i: number) => (
                                    <div key={i} className="flex items-center gap-4 text-slate-300 font-bold uppercase text-xs tracking-widest">
...
const EngineeringPage: React.FC = () => {
    ...
    return (
        <motion.div
            ...
            className="pt-24 bg-slate-950 min-h-screen flex flex-col"
        >
            {/* Hero Section */}
            ...
            <div className="flex-1 flex flex-col md:flex-row border-t border-slate-100 dark:border-slate-800 relative z-10">
                <div className="container mx-auto max-w-7xl flex flex-col md:flex-row">
                    ...
                    {/* Main Content Area */}
                    <main className="flex-1 min-w-0 bg-slate-950 overflow-hidden">
