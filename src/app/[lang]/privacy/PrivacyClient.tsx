...
const PrivacyPage: React.FC = () => {
    ...
    const notCollectedItems = Array.isArray(t('privacyPage.notCollected.items')) ? t('privacyPage.notCollected.items') : [];
            ...
            <section className="relative py-24 overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative max-w-4xl">
                    <ScrollReveal>
                        ...
                        <p className="text-slate-400 mb-12 font-light">{t('privacyPage.lastUpdated')}</p>

                        <div className="space-y-16 text-slate-300 leading-relaxed font-light">
                            {/* 핵심 원칙 */}
                            ...
                            <section className="space-y-8">
                                <div className="grid md:grid-cols-2 gap-8">
                                    <div className="space-y-4 p-8 bg-slate-50 dark:bg-white/5 rounded-3xl border border-white/5">
                                        <Lock size={24} className="text-violet-500" />
                                        <h3 className="text-xl font-bold text-white">{t('privacyPage.notCollected.title')}</h3>
                                        <ul className="text-sm space-y-2 opacity-80">
                                            {notCollectedItems.map((item: string, i: number) => (
                                                <li key={i}>- {item}</li>
                                            ))}
                                        </ul>
                                    </div>
                                    <div className="space-y-4 p-8 bg-slate-50 dark:bg-white/5 rounded-3xl border border-white/5">
                                        ...
                                        <h3 className="text-xl font-bold text-white">{t('privacyPage.storage.title')}</h3>
                                        <p
                                            className="text-sm"
                            ...
                            <section className="space-y-4">
                                <h2 className="text-2xl font-bold text-white">{t('privacyPage.payment.title')}</h2>
                                <p>
                            ...
                            <section className="space-y-4">
                                <h2 className="text-2xl font-bold text-white">{t('privacyPage.destruction.title')}</h2>
                                <p>
                            ...
                            <section className="space-y-4">
                                <h2 className="text-2xl font-bold text-white">{t('privacyPage.contact.title')}</h2>
                                <p>
