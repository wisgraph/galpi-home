...
const FeatureSection: React.FC<FeatureSectionProps> = ({ feature, index }) => {
    ...
    return (
        <section className="py-24 md:py-40 border-b border-white/5 overflow-hidden">
                        ...
                        <ScrollReveal direction={isEven ? "left" : "right"}>
                            ...
                            <div className="space-y-10">
                                ...
                                <div className="grid gap-4 pt-4">
                                    {Array.isArray(feature.points) && feature.points.map((p: string, i: number) => (
                                ...
                                <div className="flex flex-wrap gap-3 pt-6">
                                    {Array.isArray(feature.videos) && feature.videos.map((v: any, i: number) => (
                                        <button
                                            key={i}
                                            ...
                                            className={`px-6 py-2.5 rounded-2xl text-sm font-black transition-all duration-300 border ${activeIdx === i
                                                ...
                                                : "bg-transparent text-slate-500 dark:text-slate-500 border-slate-800 hover:border-slate-400 dark:hover:border-slate-600 hover:text-slate-900 dark:hover:text-slate-300 font-bold"
                                                }`}
                                        >
                                            {v.label}
                                        </button>
        ...
        <div className="bg-slate-950 min-h-screen">
            ...
            <section className="relative pt-48 pb-24 overflow-hidden border-b border-white/5">
                ...
                <div className="container mx-auto px-6 relative z-10 text-center">
                    <ScrollReveal>
                        <h1
                            className="text-5xl md:text-8xl font-black text-white mb-10 tracking-[ -0.05em] leading-[0.9]"
                            dangerouslySetInnerHTML={{ __html: t('featuresPage.hero.title') }}
                        />

                        <p
                            className="text-2xl md:text-3xl text-slate-400 max-w-4xl mx-auto leading-relaxed font-light"
            ...
            <section className="py-48 bg-slate-950 relative overflow-hidden text-center">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <ScrollReveal>
                        <h2
                            className="text-4xl md:text-7xl font-black text-white mb-10 tracking-tight"
                            dangerouslySetInnerHTML={{ __html: t('featuresPage.cta.title') }}
                        />
                        <p
                            className="text-2xl text-slate-400 mb-16 max-w-3xl mx-auto font-light leading-relaxed"
