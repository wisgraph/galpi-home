...
const FAQPage: React.FC = () => {
    ...
    const faqCategories = [
        {
            ...
            faqs: Array.isArray(t('faqPage.categories.comparison.faqs')) ? t('faqPage.categories.comparison.faqs') : []
        },
        {
            id: 'sustainability',
            icon: Shield,
            ...
            faqs: Array.isArray(t('faqPage.categories.sustainability.faqs')) ? t('faqPage.categories.sustainability.faqs') : []
        },
        {
            id: 'data',
            icon: Database,
            ...
            faqs: Array.isArray(t('faqPage.categories.data.faqs')) ? t('faqPage.categories.data.faqs') : []
        },
        {
            id: 'technical',
            icon: RefreshCw,
            ...
            faqs: Array.isArray(t('faqPage.categories.technical.faqs')) ? t('faqPage.categories.technical.faqs') : []
        },
        {
            id: 'refund',
            icon: CreditCard,
            ...
            color: 'text-rose-500',
            faqs: Array.isArray(t('faqPage.categories.refund.faqs')) ? t('faqPage.categories.refund.faqs') : []
        }
    ];
    ...
    return (
        ...
        >
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={`transition-all duration-500 rounded-[2.5rem] border ${isOpen
                                                ? 'bg-slate-900 border-violet-300 dark:border-violet-500/30 shadow-2xl shadow-violet-500/5'
                                        ...
                                        >
                                            ...
                                            >
                                                <span className={`text-xl font-bold tracking-tight transition-colors ${isOpen ? 'text-violet-600 dark:text-violet-400' : 'text-slate-300'
                                                    }`}>
                                                    Q. "{faq.question}"
                                                </span>
                                            ...
                                            <AnimatePresence>
                                                {isOpen && (
                                                    ...
                                                    >
                                                        <div className="px-8 pb-10 text-slate-400 leading-relaxed text-lg font-light pt-4 border-t border-slate-50 dark:border-slate-800/50">
            ...
            {/* Outro */}
            <section className="py-32 bg-slate-950 text-white overflow-hidden relative border-t border-slate-200 dark:border-white/5">
