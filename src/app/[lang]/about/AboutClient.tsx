...
const AboutPage: React.FC = () => {
    ...
    return (
        ...
        >
                ...
                <div className="container mx-auto px-6">
                    <ScrollReveal>
                        <div className="max-w-3xl mx-auto">
                            <div className="bg-slate-50 dark:bg-slate-900/50 rounded-3xl p-8 md:p-12 border border-slate-800 text-center">
                                <h2
                                    className="text-3xl font-serif font-bold text-white mb-6"
                                    dangerouslySetInnerHTML={{ __html: t('aboutPage.dictionary.title') }}
                                />
                                <div className="space-y-4 text-lg md:text-xl text-slate-400 leading-relaxed font-serif">
            ...
            {/* 개발자 노트 */}
            <section className="py-24 bg-slate-50 dark:bg-slate-900/50 border-y border-slate-800">
                <div className="container mx-auto px-6">
                    <ScrollReveal>
                        <div className="max-w-4xl mx-auto">
                            <h2
                                className="text-3xl md:text-5xl font-black text-white mb-12 text-center tracking-tight"
                                dangerouslySetInnerHTML={{ __html: t('aboutPage.engineerNote.title') }}
                            />

                            <div className="bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-3xl p-8 md:p-12 relative overflow-hidden shadow-xl">
                                <div className="prose prose-lg dark:prose-invert max-w-none relative z-10">
                                    ...
                                    <div className="space-y-8 text-slate-400 leading-relaxed text-lg">
                                        {Array.isArray(engineerParagraphs) && engineerParagraphs.map((p: string, idx: number) => (
                                            <p
                                                key={idx}
                                                className={idx === 1 ? "font-bold text-white text-xl" : (idx === 3 ? "text-2xl font-black text-white pt-4" : (idx === 4 ? "border-t border-slate-100 dark:border-slate-800 pt-8 mt-8" : ""))}
            ...
            <section className="py-24 bg-slate-950">
                <div className="container mx-auto px-6">
                    <ScrollReveal>
                        <div className="max-w-4xl mx-auto">
                            <h2
                                className="text-3xl md:text-5xl font-black text-white mb-16 text-center"
                            ...
                            <div className="grid md:grid-cols-2 gap-12 items-center">
                                ...
                                <div className="relative">
                                    <div className="bg-gradient-to-br from-rose-500 to-pink-500 rounded-3xl aspect-square flex items-center justify-center p-1 shadow-2xl shadow-rose-500/20">
                                        <div className="bg-slate-900 w-full h-full rounded-[20px] flex flex-col items-center justify-center text-center p-8 relative overflow-hidden">
                    ...
                    <ScrollReveal>
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            <div className="grid md:grid-cols-2 gap-8 mb-16">
                                <div className="bg-white dark:bg-white/5 backdrop-blur-sm p-8 rounded-3xl border border-white/10 text-left shadow-xl dark:shadow-none">
                ...
                <div className="container mx-auto px-6">
                    <ScrollReveal>
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            />
                            <p className="text-2xl md:text-3xl font-bold text-slate-400 mb-12">
