...
const TermsPage: React.FC = () => {
    ...
    const sections = Array.isArray(t('termsPage.sections')) ? t('termsPage.sections') : [];
            ...
            <section className="relative py-24 overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative max-w-4xl">
                    <ScrollReveal>
                        ...
                        <p className="text-slate-400 mb-12 font-light">{t('termsPage.lastUpdated')}</p>
                        ...
                        <div className="space-y-16 text-slate-300 leading-relaxed font-light">
                            {sections.map((section: any, idx: number) => (
                                <section key={section.id || idx} className="space-y-4">
                                    ...
                                    {section.id === '03' && Array.isArray(section.items) ? (
