    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-black font-sans selection:bg-rose-500/30">
            ...
            <main className="max-w-4xl mx-auto px-6 pb-32 relative z-10 space-y-24">
                ...
                {/* Concept */}
                <section className="bg-slate-900 rounded-3xl shadow-xl overflow-hidden border border-slate-800">
                    <div className="grid md:grid-cols-2">
                        <div className="p-8 md:p-12">
                            <h2 className="text-3xl font-black text-white mb-6">{t('engineeringPage.featureDetails.typedTags.concept.title')}</h2>
                            <p
                            ...
                            <div className="space-y-3 font-mono text-sm">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="px-2 py-1 bg-slate-800 rounded text-slate-400">#design</span>
                                </div>
                                <div className="flex items-center gap-3">
                        ...
                        <div className="bg-slate-100 dark:bg-black/50 p-8 md:p-12 flex items-center justify-center relative overflow-hidden">
                            ...
                            <div className="relative z-10 space-y-4 w-full max-w-sm">
                                <div className="p-4 bg-slate-900 rounded-xl shadow-sm border border-slate-800 flex items-center gap-2">
                                    <span className="w-2 h-8 bg-blue-500 rounded-full" />
                                    <div>
                                        <div className="text-xs text-slate-400 font-bold uppercase">Project</div>
                                        <div className="font-mono text-white">#project:antigravity</div>
                                    </div>
                                </div>
                                <div className="p-4 bg-slate-900 rounded-xl shadow-sm border border-slate-800 flex items-center gap-2">
                                    ...
                                    <div>
                                        ...
                                        <div className="font-mono text-white">#status:doing</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section className="grid md:grid-cols-3 gap-8">
                    <div className="space-y-4">
                        ...
                        <h4 className="font-bold text-lg text-white">{t('engineeringPage.featureDetails.typedTags.features.preset.title')}</h4>
                        <p
                    ...
                    <div className="space-y-4">
                        ...
                        <h4 className="font-bold text-lg text-white">{t('engineeringPage.featureDetails.typedTags.features.palette.title')}</h4>
                        <p
                            className="text-sm text-slate-400"
                    ...
                    <div className="space-y-4">
                        ...
                        <h4 className="font-bold text-lg text-white">{t('engineeringPage.featureDetails.typedTags.features.implicit.title')}</h4>
                        <p
                            className="text-sm text-slate-400"
                ...
                {/* Use Cases List */}
                <section>
                    <h3 className="text-2xl font-bold text-white mb-8">{t('engineeringPage.featureDetails.typedTags.smartSuggest.title')}</h3>
                    <div className="grid md:grid-cols-2 gap-4">
                        <div className="flex items-center gap-4 p-4 bg-slate-50 dark:bg-slate-900/50 rounded-xl border border-slate-800">
                            ...
                            <span className="text-slate-400 text-sm">{t('engineeringPage.featureDetails.typedTags.smartSuggest.statusLabel')}</span>
                        </div>
                        <div className="flex items-center gap-4 p-4 bg-slate-50 dark:bg-slate-900/50 rounded-xl border border-slate-800">
                            ...
                            <span className="text-slate-400 text-sm">{t('engineeringPage.featureDetails.typedTags.smartSuggest.priorityLabel')}</span>
                        </div>
                    </div>
                </section>
