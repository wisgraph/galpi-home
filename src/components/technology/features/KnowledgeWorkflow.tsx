            ...
            <main className="max-w-4xl mx-auto px-6 pb-32 relative z-10 space-y-24">
                ...
                <section className="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <h2 className="text-3xl font-bold text-white mb-4">{t('engineeringPage.featureDetails.knowledgeWorkflow.contextFixing.title')}</h2>
                            ...
                            {(() => {
                                ...
                                return steps.map((step: string, i: number) => (
                                    <li key={i} className="flex items-center gap-3 text-sm text-slate-300">
                                        <span className={`w-6 h-6 rounded-full flex items-center justify-center font-bold text-xs ${i === 2 ? 'bg-teal-500 text-white' : 'bg-slate-800 text-slate-500'}`}>
                    ...
                    <div className="bg-slate-100 dark:bg-slate-900 rounded-2xl p-8 border border-slate-800 relative min-h-[300px] flex items-center justify-center">
                        ...
                        <div className="relative z-10 flex flex-col items-center gap-4">
                            ...
                            <div className="flex gap-2">
                                <div className="p-3 bg-white dark:bg-black rounded-lg shadow-sm border border-slate-800 animate-pulse">file_1.pdf</div>
                                <div className="p-3 bg-white dark:bg-black rounded-lg shadow-sm border border-slate-800 animate-pulse delay-75">link_2.url</div>
                                <div className="p-3 bg-white dark:bg-black rounded-lg shadow-sm border border-slate-800 animate-pulse delay-150">note_3.md</div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section>
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <h2 className="text-3xl font-bold text-white">{t('engineeringPage.featureDetails.knowledgeWorkflow.digitalDesk.title')}</h2>
                    </div>

                    <div className="bg-slate-50 dark:bg-slate-900 text-white rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden shadow-xl dark:shadow-3xl border border-slate-200 dark:border-white/5">
                            ...
                            <div className="space-y-4 font-mono text-sm">
                                <div className="flex items-center gap-4 p-4 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors cursor-pointer group">
                                    ...
                                    <div className="flex-1">
                                        <div className="text-slate-400 text-xs">{t('engineeringPage.featureDetails.knowledgeWorkflow.digitalDesk.previousContext')}</div>
                                        <div className="font-bold text-white">Project Alpha</div>
                                    </div>
                ...
                <section className="text-center">
                    <h2 className="text-3xl font-bold text-white mb-12">{t('engineeringPage.featureDetails.knowledgeWorkflow.perfectLoop.title')}</h2>
                    ...
                    <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-center gap-8 relative">
                        ...
                        <div className="w-full md:w-1/3 bg-slate-900 p-6 rounded-2xl border border-slate-800 shadow-lg">
                            <div className="w-12 h-12 mx-auto bg-slate-800 rounded-full flex items-center justify-center text-slate-400 mb-4 font-black">1</div>
                            <h3 className="font-bold text-lg mb-2 text-white">{t('engineeringPage.featureDetails.knowledgeWorkflow.perfectLoop.capture.title')}</h3>
                            <p
                        ...
                        <div className="w-full md:w-1/3 bg-slate-900 p-6 rounded-2xl border border-slate-800 shadow-lg">
                            <div className="w-12 h-12 mx-auto bg-slate-800 rounded-full flex items-center justify-center text-slate-400 mb-4 font-black">2</div>
                            <h3 className="font-bold text-lg mb-2 text-white">{t('engineeringPage.featureDetails.knowledgeWorkflow.perfectLoop.organize.title')}</h3>
                            <p
                                className="text-sm text-slate-500"
                        ...
                        <div className="w-full md:w-1/3 bg-slate-900 p-6 rounded-2xl border border-slate-800 shadow-lg">
                            <div className="w-12 h-12 mx-auto bg-slate-800 rounded-full flex items-center justify-center text-slate-400 mb-4 font-black">3</div>
                            <h3 className="font-bold text-lg mb-2 text-white">{t('engineeringPage.featureDetails.knowledgeWorkflow.perfectLoop.jump.title')}</h3>
                            <p
                                className="text-sm text-slate-500"
