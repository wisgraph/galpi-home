  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-7xl pointer-events-none z-0">
        <div className="absolute top-[20%] left-[10%] w-[500px] h-[500px] bg-violet-900/20 rounded-full blur-[120px] animate-pulse-slow"></div>
      </div>
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        ...
        <h1
          ref={addToRefs}
          className="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight mb-8 leading-[1.1] text-white"
        ...
        >
          <Link
            ...
            className="px-8 py-4 bg-white text-slate-900 rounded-full font-bold text-lg hover:scale-105 transition-transform shadow-xl hover:shadow-violet-500/20 flex items-center gap-2"
          >
          ...
          <Link
            ...
            className="px-8 py-4 border border-slate-800 text-slate-300 rounded-full font-semibold text-lg hover:bg-slate-900 transition-colors flex items-center gap-2"
          >
