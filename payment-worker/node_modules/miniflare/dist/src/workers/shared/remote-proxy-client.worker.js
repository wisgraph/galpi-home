...
var Client = class extends WorkerEntrypoint {
  ...
  constructor(ctx, env) {
    ...
    if (env.remoteProxyConnectionString) {
      ...
      url.protocol = "ws:", url.searchParams.set("MF-Binding", env.binding), env.bindingType && url.searchParams.set("MF-Binding-Type", env.bindingType), stub = newWebSocketRpcSession2(url.href);
    }
